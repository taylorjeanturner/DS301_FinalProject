...
df$AgeCategory = ifelse(df$AgeCategory == '18-24', 21,
                        ifelse(df$AgeCategory == '25-29', 27,
                               ifelse(df$AgeCategory == '30-34', 32,
                                      ifelse(df$AgeCategory == '35-39', 37,
                                             ifelse(df$AgeCategory == '40-44', 42,
                                                    ifelse(df$AgeCategory == '45-49', 47,
                                                           ifelse(df$AgeCategory == '50-54', 52,
                                                                  ifelse(df$AgeCategory == '55-59', 57,
                                                                         ifelse(df$AgeCategory == '60-64', 62,
                                                                                ifelse(df$AgeCategory == '65-69', 67,
                                                                                       ifelse(df$AgeCategory == '70-74', 72,
                                                                                              ifelse(df$AgeCategory == '75-79', 77,
                                                                                                     ifelse(df$AgeCategory == '80 or older', 80, 0)))))))))))))
